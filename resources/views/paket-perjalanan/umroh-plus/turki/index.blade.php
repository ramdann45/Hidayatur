...
@section('content')
    <section class="container paket-islami px-3">
        ...
        <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16 pt-5">
            <h2 class="mb-4 text-2xl md:text-4xl tracking-tight font-extrabold text-gray-900">{{ $uzb->nama }}
            </h2>
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="gap-8 items-center px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 lg:px-6">
                <img class="w-full" src="{{ asset($uzb->img) }}" alt="{{ $uzb->nama }}">
            ...
            <div class="gap-8 items-center px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 lg:px-6">
                <div class="accordion js-accordion">
                    <div class="accordion__item js-accordion-item active">
                        <div class="accordion-header js-accordion-header">{{ $uzb->title_1 }}</div>
                        <div class="accordion-body js-accordion-body">
                            <div class="accordion-body__contents">
                                <h5 style="text-align: justify;">{{ $uzb->hari_1 }}</h5>
                            </div>
                        </div>
                    </div>
                    <div class="accordion__item js-accordion-item">
                        <div class="accordion-header js-accordion-header">{{ $uzb->title_2 }}</div>
                        <div class="accordion-body js-accordion-body">
                            <div class="accordion-body__contents">
                    ...
                    <div class="accordion__item js-accordion-item">
                        <div class="accordion-header js-accordion-header">{{ $uzb->title_3 }}</div>
                        <div class="accordion-body js-accordion-body">
                            <div class="accordion-body__contents">
                                <h6 style="text-align: justify;">
                                    {{ $uzb->hari_3 }}
                    ...
                    <div class="accordion__item js-accordion-item">
                        <div class="accordion-header js-accordion-header">{{ $uzb->title_4 }}</div>
                        <div class="accordion-body js-accordion-body">
                            <div class="accordion-body__contents">
                                <h6 style="text-align: justify;">
                                    {{ $uzb->hari_4 }}
                    ...
                    <div class="accordion__item js-accordion-item">
                        <div class="accordion-header js-accordion-header">{{ $uzb->title_5 }}</div>
                        <div class="accordion-body js-accordion-body">
                            <div class="accordion-body__contents">
                                <h6 style="text-align: justify;">
                                    {{ $uzb->hari_5 }}
                    ...
                    <div class="accordion__item js-accordion-item">
                        <div class="accordion-header js-accordion-header">{{ $uzb->title_6 }}</div>
                        <div class="accordion-body js-accordion-body">
                            <div class="accordion-body__contents">
                                <h6 style="text-align: justify;">
                                    {{ $uzb->hari_6 }}
                    ...
                    <div class="accordion__item js-accordion-item">
                        <div class="accordion-header js-accordion-header">{{ $uzb->title_7 }}</div>
                        <div class="accordion-body js-accordion-body">
                            <div class="accordion-body__contents">
                                <h6 style="text-align: justify;">
                                    {{ $uzb->hari_7 }}
                    ...
                    <div class="accordion__item js-accordion-item">
                        <div class="accordion-header js-accordion-header">{{ $uzb->title_8 }}</div>
                        <div class="accordion-body js-accordion-body">
                            <div class="accordion-body__contents">
                                <h6 style="text-align: justify;">
                                    {{ $uzb->hari_8 }}
                    ...
                    <div class="accordion__item js-accordion-item">
                        <div class="accordion-header js-accordion-header">{{ $uzb->title_9 }}</div>
                        <div class="accordion-body js-accordion-body">
                            <div class="accordion-body__contents">
                                <h6 style="text-align: justify;">
                                    {{ $uzb->hari_9 }}
                    ...
                    <div class="accordion__item js-accordion-item">
                        <div class="accordion-header js-accordion-header">{{ $uzb->title_10 }}</div>
                        <div class="accordion-body js-accordion-body">
                            <div class="accordion-body__contents">
                                <h6 style="text-align: justify;">
                                    {{ $uzb->hari_10 }}
                    ...
                    @if (request()->is('paket-pekerjaan/umroh-plus/turki/umroh-plus-turki-10d-hidayatur'))
                    @else
                        <div class="accordion__item js-accordion-item">
                            <div class="accordion-header js-accordion-header">{{ $uzb->title_11 }}</div>
                            <div class="accordion-body js-accordion-body">
                                <div class="accordion-body__contents">
                                    <h6 style="text-align: justify;">
                                        {{ $uzb->hari_11 }}
                        ...
                        <div class="accordion__item js-accordion-item">
                            <div class="accordion-header js-accordion-header">{{ $uzb->title_12 }}</div>
                            <div class="accordion-body js-accordion-body">
                                <div class="accordion-body__contents">
                                    <h6 style="text-align: justify;">
                                        {{ $uzb->hari_12 }}
                    ...
                    @if (request()->is('paket-pekerjaan/umroh-plus/turki/umroh-akhir-syawal-turki-hidayatur'))
                        <div class="accordion__item js-accordion-item">
                            <div class="accordion-header js-accordion-header">{{ $uzb->title_13 }}</div>
                            <div class="accordion-body js-accordion-body">
                                <div class="accordion-body__contents">
                                    <h6 style="text-align: justify;">
                                        {{ $uzb->hari_13 }}
                        ...
                        <div class="accordion__item js-accordion-item">
                            <div class="accordion-header js-accordion-header">{{ $uzb->title_14 }}</div>
                            <div class="accordion-body js-accordion-body">
                                <div class="accordion-body__contents">
                                    <h6 style="text-align: justify;">
                                        {{ $uzb->hari_14 }}
                        ...
                        <div class="accordion__item js-accordion-item">
                            <div class="accordion-header js-accordion-header">{{ $uzb->title_15 }}</div>
                            <div class="accordion-body js-accordion-body">
                                <div class="accordion-body__contents">
                                    <h6 style="text-align: justify;">
                                        {{ $uzb->hari_15 }}
