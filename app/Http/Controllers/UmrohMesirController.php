...
class UmrohMesirController extends Controller
{
    public function paketSatu()
    {
        $data = DB::table('umroh_mesir')->where('id', 1)->first();
        return view('admin.umroh-mesir.paket-1', compact('data'));
    }
    ...
    public function paketSatuUpdate(Request $request)
    {
        ...
        $img_old = DB::table('umroh_mesir')->where('id', 1)->first();
        ...
        if ($request->hasFile('img-input')) {
            ...
            DB::table('umroh_mesir')->where('id', 1)->update([
                'nama' => $nama,
                'title_1' => $title_1,
                'hari_1' => $hari_1,
                'title_2' => $title_2,
    ...
    {
        $data = DB::table('umroh_mesir')->where('id', 2)->first();
        return view('admin.umroh-mesir.paket-2', compact('data'));
    }
    ...
    public function paketDuaUpdate(Request $request)
    {
        ...
        $img_old = DB::table('umroh_mesir')->where('id', 2)->first();
        ...
        if ($request->hasFile('img-input')) {
            ...
            DB::table('umroh_mesir')->where('id', 2)->update([
                'nama' => $nama,
                'title_1' => $title_1,
                'hari_1' => $hari_1,
                'title_2' => $title_2,
    ...
    {
        $data = DB::table('umroh_mesir')->where('id', 3)->first();
        return view('admin.umroh-mesir.paket-3', compact('data'));
    }
    ...
    public function paketTigaUpdate(Request $request)
    {
        ...
        $img_old = DB::table('umroh_mesir')->where('id', 3)->first();
        ...
        if ($request->hasFile('img-input')) {
            ...
            DB::table('umroh_mesir')->where('id', 3)->update([
                'nama' => $nama,
                'title_1' => $title_1,
                'hari_1' => $hari_1,
                'title_2' => $title_2,
