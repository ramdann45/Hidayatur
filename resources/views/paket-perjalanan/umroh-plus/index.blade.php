...
@section('content')
    <section class="container paket-islami px-3">
        ...
        <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16 pt-5">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900">Umroh plus Turki
            </h2>
            <hr class="h-px my-8 bg-gray-200 border-0">
        </div>

        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            @foreach ($turki as $umroh)
                <div>
                    <div
                        ...
                        <div class="p-5">
                            ...
                            <a href="/paket-perjalanan/umroh-plus/turki/{{ $umroh->slug }}"
        ...
        <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16 pt-5">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900">Umroh plus Mesir
            </h2>
            <hr class="h-px my-8 bg-gray-200 border-0">
        </div>

        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            @foreach ($mesir as $umroh)
                <div>
                    <div
                        class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <a href="#">
                        ...
                        <div class="p-5">
                            ...
                            <a href="/paket-perjalanan/umroh-plus/mesir/{{ $umroh->slug }}"
                                class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Detail Paket
                                <svg aria-hidden="true" class="w-4 h-4 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16 pt-5">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900">Umroh plus Dubai
            </h2>
            <hr class="h-px my-8 bg-gray-200 border-0">
        </div>

        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            @foreach ($dubai as $umroh)
                <div>
                    <div
                        class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <a href="#">
                            <img class="rounded-t-lg" src="{{ asset($umroh->img) }}" alt="{{ $umroh->nama }}" />
                        </a>
                        <div class="p-5">
                            <a href="#">
                                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                            ...
                            <a href="/paket-perjalanan/umroh-plus/dubai/{{ $umroh->slug }}"
                                class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Detail Paket
                                <svg aria-hidden="true" class="w-4 h-4 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16 pt-5">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900">Umroh plus Uzbekistan
            </h2>
            <hr class="h-px my-8 bg-gray-200 border-0">
        </div>
            ...
            @foreach ($uzb as $u)
                <div>
                    <div
                        class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <a href="#">
                            <img class="rounded-t-lg" src="{{ asset($u->img) }}" alt="{{ $u->nama }}" />
                        </a>
                        <div class="p-5">
                            <a href="#">
                                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                            ...
                            <a href="/paket-perjalanan/umroh-plus/uzbekistan/{{ $u->slug }}"
                                class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Detail Paket
                                <svg aria-hidden="true" class="w-4 h-4 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
