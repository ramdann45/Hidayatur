...
class UmrohTurkiController extends Controller
{
    public function paketSatu()
    {
        $data = DB::table('umroh_turki')->where('id', 1)->first();
        return view('admin.umroh-turki.paket-1', compact('data'));
    }
    ...
    public function paketSatuUpdate(Request $request)
    {
        ...
        $request->validate([
            ...
            'title-14' => 'required|min:3',
            'hari-14' => 'required|min:3',
            'title-15' => 'required|min:3',
            'hari-15' => 'required|min:3',
        ...
        $img_old = DB::table('umroh_turki')->where('id', 1)->first();
        ...
        if ($request->hasFile('img-input')) {
            ...
            DB::table('umroh_turki')->where('id', 1)->update([
                'nama' => $nama,
                'title_1' => $title_1,
                'hari_1' => $hari_1,
                'title_2' => $title_2,
    ...
    {
        $data = DB::table('umroh_turki')->where('id', 2)->first();
        return view('admin.umroh-turki.paket-2', compact('data'));
    }
    ...
    public function paketDuaUpdate(Request $request)
    {
        ...
        $img_old = DB::table('umroh_turki')->where('id', 2)->first();
        ...
        if ($request->hasFile('img-input')) {
            ...
            DB::table('umroh_turki')->where('id', 2)->update([
                'nama' => $nama,
                'title_1' => $title_1,
                'hari_1' => $hari_1,
                'title_2' => $title_2,
    ...
    {
        $data = DB::table('umroh_turki')->where('id', 3)->first();
        return view('admin.umroh-turki.paket-3', compact('data'));
    }
    ...
    public function paketTigaUpdate(Request $request)
    {
        ...
        $img_old = DB::table('umroh_turki')->where('id', 3)->first();
        ...
        if ($request->hasFile('img-input')) {
            ...
            DB::table('umroh_turki')->where('id', 3)->update([
                'nama' => $nama,
                'title_1' => $title_1,
                'hari_1' => $hari_1,
                'title_2' => $title_2,
    ...
    {
        $data = DB::table('umroh_turki')->where('id', 4)->first();
        return view('admin.umroh-turki.paket-4', compact('data'));
    }
    ...
    public function paketEmpatUpdate(Request $request)
    {
        ...
        $img_old = DB::table('umroh_turki')->where('id', 4)->first();
        ...
        if ($request->hasFile('img-input')) {
            ...
            DB::table('umroh_turki')->where('id', 4)->update([
                'nama' => $nama,
                'title_1' => $title_1,
                'hari_1' => $hari_1,
                'title_2' => $title_2,
