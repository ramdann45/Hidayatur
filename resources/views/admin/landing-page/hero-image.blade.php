...
@section('content')
    <section class="container mx-auto px-3">
        ...
        <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900">Hero Image
            </h2>
                ...
                <div class="relative">
                    ...
                    <div class="absolute top-2 right-0">
                        <button id="show-btn" data-modal-target="updateModal" data-modal-toggle="updateModal"
                            ...
                            data-id="{{ $s->id }}"><i class="fa fa-pen"></i></button>
                        <button id="delete-btn" type="button"
                            ...
                            data-id="{{ $s->id }}"><i class="fa fa-trash-can"></i></button>
                    </div>
                </div>
            @endforeach
        </div>
                    ...
                    <form id="add-btn" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <label class="block mb-2 mt-4 text-sm font-medium text-gray-900 dark:text-white"
                                for="title">Tema Gambar <span class="text-red-500">*</span></label>
                            <input
                        ...
                        <div class="mb-6">
                            ...
                            <label class="block mb-2 mt-4 text-sm font-medium text-gray-900 dark:text-white"
                                for="img_input">Upload Foto <span class="text-red-500">*</span></label>
                            <input
                                class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">PNG, JPG or
                                JPEG (Max. 5MB).</p>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">Ukuran gambar
                                harus 2050 x 520 agar menampilkan gambar yang optimal.</p>
                        </div>
                        <div
                ...
                <div class="p-6 space-y-6">
                    ...
                    <form id="update-form" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <label class="block mb-2 mt-4 text-sm font-medium text-gray-900 dark:text-white"
                                for="title_update">Ganti Tema Gambar <span class="text-red-500">*</span></label>
                            <input
                                class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                                id="title_update" name="title_update" type="text">
                        </div>
                        <img class="h-auto max-w-xs" alt="image description" id="img-update" width="350">
                        <div class="mb-6">
...
@section('script')
    <script src="{{ asset('ajax/landing-page/heroImage.js') }}"></script>
@endsection
