...
@section('content')
    <section class="container paket-islami px-3">
        ...
        <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16 pt-5">
            <h2 class="mb-4 text-2xl md:text-4xl tracking-tight font-extrabold text-gray-900">{{ $allPaket->nama }}
            </h2>
            ...
            <div class="gap-8 items-center px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 lg:px-6">
                <div class="accordion js-accordion">
                    <div class="accordion__item js-accordion-item active">
                        <div class="accordion-header js-accordion-header">{{ $allPaket->title_1 }}</div>
                        <div class="accordion-body js-accordion-body">
                            <div class="accordion-body__contents">
                                <h5 style="text-align: justify;">{{ $allPaket->hari_1 }}</h5>
                            </div>
                        </div>
                    </div>
                    <div class="accordion__item js-accordion-item">
                        <div class="accordion-header js-accordion-header">{{ $allPaket->title_2 }}</div>
                        <div class="accordion-body js-accordion-body">
                            <div class="accordion-body__contents">
                    ...
                    <div class="accordion__item js-accordion-item">
                        <div class="accordion-header js-accordion-header">{{ $allPaket->title_3 }}</div>
                        <div class="accordion-body js-accordion-body">
                            <div class="accordion-body__contents">
                                <h6 style="text-align: justify;">
                                    {{ $allPaket->hari_3 }}
                    ...
                    <div class="accordion__item js-accordion-item">
                        <div class="accordion-header js-accordion-header">{{ $allPaket->title_4 }}</div>
                        <div class="accordion-body js-accordion-body">
                            <div class="accordion-body__contents">
                                <h6 style="text-align: justify;">
                                    {{ $allPaket->hari_4 }}
                    ...
                    <div class="accordion__item js-accordion-item">
                        <div class="accordion-header js-accordion-header">{{ $allPaket->title_5 }}</div>
                        <div class="accordion-body js-accordion-body">
                            <div class="accordion-body__contents">
                                <h6 style="text-align: justify;">
                                    {{ $allPaket->hari_5 }}
                    ...
                    <div class="accordion__item js-accordion-item">
                        <div class="accordion-header js-accordion-header">{{ $allPaket->title_6 }}</div>
                        <div class="accordion-body js-accordion-body">
                            <div class="accordion-body__contents">
                                <h6 style="text-align: justify;">
                                    {{ $allPaket->hari_6 }}
                    ...
                    <div class="accordion__item js-accordion-item">
                        <div class="accordion-header js-accordion-header">{{ $allPaket->title_7 }}</div>
                        <div class="accordion-body js-accordion-body">
                            <div class="accordion-body__contents">
                                <h6 style="text-align: justify;">
                                    {{ $allPaket->hari_7 }}
                    ...
                    <div class="accordion__item js-accordion-item">
                        <div class="accordion-header js-accordion-header">{{ $allPaket->title_8 }}</div>
                        <div class="accordion-body js-accordion-body">
                            <div class="accordion-body__contents">
                                <h6 style="text-align: justify;">
                                    {{ $allPaket->hari_8 }}
                    ...
                    <div class="accordion__item js-accordion-item">
                        <div class="accordion-header js-accordion-header">{{ $allPaket->title_9 }}</div>
                        <div class="accordion-body js-accordion-body">
                            <div class="accordion-body__contents">
                                <h6 style="text-align: justify;">
                                    {{ $allPaket->hari_9 }}
                    ...
                    <div class="accordion__item js-accordion-item">
                        <div class="accordion-header js-accordion-header">{{ $allPaket->title_10 }}</div>
                        <div class="accordion-body js-accordion-body">
                            <div class="accordion-body__contents">
                                <h6 style="text-align: justify;">
                                    {{ $allPaket->hari_10 }}
                    ...
                    @if (request()->is('paket-pekerjaan/umroh/umroh-akhir-hidayatur'))
                    @else
                        <div class="accordion__item js-accordion-item">
                            <div class="accordion-header js-accordion-header">{{ $allPaket->title_11 }}</div>
                            <div class="accordion-body js-accordion-body">
                                <div class="accordion-body__contents">
                                    <h6 style="text-align: justify;">
                                        {{ $allPaket->hari_11 }}
                        ...
                        <div class="accordion__item js-accordion-item">
                            <div class="accordion-header js-accordion-header">{{ $allPaket->title_12 }}</div>
                            <div class="accordion-body js-accordion-body">
                                <div class="accordion-body__contents">
                                    <h6 style="text-align: justify;">
                                        {{ $allPaket->hari_12 }}
                    ...
                    @if (request()->is('paket-pekerjaan/umroh/umroh-akhir-syawal-hidayatur'))
                        <div class="accordion__item js-accordion-item">
                            <div class="accordion-header js-accordion-header">{{ $allPaket->title_13 }}</div>
                            <div class="accordion-body js-accordion-body">
                                <div class="accordion-body__contents">
                                    <h6 style="text-align: justify;">
                                        {{ $allPaket->hari_13 }}
                        ...
                        <div class="accordion__item js-accordion-item">
                            <div class="accordion-header js-accordion-header">{{ $allPaket->title_14 }}</div>
                            <div class="accordion-body js-accordion-body">
                                <div class="accordion-body__contents">
                                    <h6 style="text-align: justify;">
                                        {{ $allPaket->hari_14 }}
                        ...
                        <div class="accordion__item js-accordion-item">
                            <div class="accordion-header js-accordion-header">{{ $allPaket->title_15 }}</div>
                            <div class="accordion-body js-accordion-body">
                                <div class="accordion-body__contents">
                                    <h6 style="text-align: justify;">
                                        {{ $allPaket->hari_15 }}
