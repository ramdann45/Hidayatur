...
@section('content')
    <section class="container px-3">
        ...
        <form method="post" id="update-paket">
            ...
            <div class="mb-6">
                <label for="title-12" class="block mb-2 text-sm font-medium text-gray-900">Title Hari Ke-12</label>
                <input type="text" id="title-12" name="title-12"
                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    required value="{{ $data->title_12 }}">
            </div>
            <div class="mb-6">
                <label for="hari-12" class="block mb-2 text-sm font-medium text-gray-900">Hari ke-12</label>
                <textarea id="hari-12" name="hari-12" rows="4"
                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500">{{ $data->hari_12 }}</textarea>
            </div>
            <div class="mb-6">
                <label for="title-13" class="block mb-2 text-sm font-medium text-gray-900">Title Hari Ke-13</label>
                <input type="text" id="title-13" name="title-13"
                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    required value="{{ $data->title_13 }}">
            </div>
            <div class="mb-6">
                <label for="hari-13" class="block mb-2 text-sm font-medium text-gray-900">Hari ke-13</label>
                <textarea id="hari-13" name="hari-13" rows="4"
                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500">{{ $data->hari_13 }}</textarea>
            </div>
            <div class="mb-6">
                <label for="title-14" class="block mb-2 text-sm font-medium text-gray-900">Title Hari Ke-14</label>
                <input type="text" id="title-14" name="title-14"
                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    required value="{{ $data->title_14 }}">
            </div>
            <div class="mb-6">
                <label for="hari-14" class="block mb-2 text-sm font-medium text-gray-900">Hari ke-14</label>
                <textarea id="hari-14" name="hari-14" rows="4"
                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500">{{ $data->hari_14 }}</textarea>
            </div>
            <div class="mb-6">
                <label for="title-15" class="block mb-2 text-sm font-medium text-gray-900">Title Hari Ke-15</label>
                <input type="text" id="title-15" name="title-15"
                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    required value="{{ $data->title_15 }}">
            </div>
            <div class="mb-6">
                <label for="hari-15" class="block mb-2 text-sm font-medium text-gray-900">Hari ke-15</label>
                <textarea id="hari-15" name="hari-15" rows="4"
                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500">{{ $data->hari_15 }}</textarea>
            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#update-paket').submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('paket.satu.turki.update') }}",
                    type: "POST",
                    data: formData,
                    cache: false,
                    contentType: false,
